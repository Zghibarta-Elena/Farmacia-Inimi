    ...
    public partial class Form1 : Form
    {
        ...
        private void buttonAdaugaMed_Click(object sender, EventArgs e)
        {
            ...
            if(string.IsNullOrEmpty(textBoxNumeMedicament.Text))
            {
                ...
                labelEroare.Text = "Introduceti un nume pentru medicament";
                return;
            }
            if(textBoxNumeMedicament.Text.Length>dimensiuneSirMax)
            {
                ...
                labelEroare.Text = "Numele medicamentului este prea lung(maxim 30 caractere)";
                return;
            }
            ...
            if(!int.TryParse(textBoxAgaudaCantitate.Text,out cantitate))
            {
                ...
                labelEroare.Text = "Introduceti un numar pentru cantitate";
                return;
            }
            ...
            else
            {
                ...
                labelEroare.Text = "Alegeti o categorie de varsta";
                return;
            }
            ...
            curataEcran();
            labelEroare.Text = "Medicamentul a fost adaugat cu succes!";
        ...
        private void buttonSalvare_Click(object sender, EventArgs e)
        {
            ...
            labelEroare.Text = "Felicitari! Medicamentelel au fost adaugate cu succes!";
